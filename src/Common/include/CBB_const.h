...
const int CBB_REQUEST_HANDLER_THREAD_NUMBER=0;
const int CBB_SENDER_THREAD_NUMBER=CBB_REQUEST_HANDLER_THREAD_NUMBER+1;
const int CBB_RECEIVER_THREAD_NUMBER=CBB_SENDER_THREAD_NUMBER+1;
const int CBB_REMOTE_TASK_THREAD_NUMBER=CBB_RECEIVER_THREAD_NUMBER+1;
const int DATA_SYNC_THREAD_NUMBER=CBB_REMOTE_TASK_THREAD_NUMBER+1;
