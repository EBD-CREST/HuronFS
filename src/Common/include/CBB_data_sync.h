	...
	namespace Common
	{
		...
		class CBB_data_sync
		{
			public:
				...
				extended_IO_task* get_data_sync_response(extended_IO_task* output_task);
		...
		inline extended_IO_task* CBB_data_sync::get_data_sync_response(extended_IO_task* output_task)
		{
